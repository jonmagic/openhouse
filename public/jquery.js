...
fn.apply(this);}});},stopping:false,stop:function(clearQueue,gotoEnd){this.stopping=true;var timers=jQuery.timers;if(clearQueue)
this.queue([]);this.each(function(){for(var i=timers.length-1;i>=0;i--)
if(timers[i].elem==this){if(gotoEnd)
timers[i](true);timers.splice(i,1);}});if(!gotoEnd)
this.dequeue();this.stopping=false;return this;}});var queue=function(elem,type,array){if(!elem)
